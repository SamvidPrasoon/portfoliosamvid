    ...
    <section className="min-h-screen bg-black px-4 md:px-6 py-20 md:py-28">
      ...
      <div className="max-w-6xl mx-auto mb-14 md:mb-20 text-center">
        ...
        <p className="mt-4 text-sm md:text-base text-neutral-400 max-w-3xl mx-auto leading-relaxed">
          An AI-powered assistant that lets you explore your database using
          natural language. Generate SQL, execute queries, and get insights
          instantly — all through conversation.
        </p>
      ...
      >
        ...
        <BentoGridItem
          ...
          header={
            <ProjectImage
              src="/aisql1.png"
              title="AI SQL STUDIO"
              description="Generate SQL, execute queries, and get insights"
            />
          }
        />
        ...
        <BentoGridItem
          ...
          header={
            <ProjectImage
              src="/aisql3.png"
              title="Chat with multiple databases"
              description=""
            />
          }
        />
        ...
        <BentoGridItem
          className="bg-black transition-transform duration-300 hover:-translate-y-1"
          header={
            <ProjectImage src="/aisql4.png" title=" " description="" compact />
          }
        />
      </BentoGrid>
    </section>
